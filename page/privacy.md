...
## 第2条（個人情報の収集方法）
当サイトは，ユーザーからのお問い合わせに際して，氏名，メールアドレスその他ユーザーが入力した情報を取得することがあります。また，アクセス解析，広告配信およびサポート機能の提供に伴い，Cookieその他の識別子，IPアドレス，ブラウザや端末に関する情報，閲覧ページ，リファラー，サービスの利用履歴および取引に関する情報を，当サイトまたは提携先を通じて取得することがあります。
...
3. メンテナンス，重要なお知らせなど必要に応じた連絡を行うため
4. 当サイトの利用状況を分析し，サービスの維持，改善および不正利用の防止を行うため
5. 広告の表示およびその効果を測定するため
6. codocを利用したサポートの受付，決済，取引管理および問い合わせ対応のため
7. 利用規約に違反したユーザーや，不正または不当な目的でサービスを利用しようとするユーザーを特定し，利用をお断りするため
8. 上記の利用目的に付随する目的
...
### codocについて
当サイトでは，番組へのサポート受付および決済のため，codoc株式会社が提供するサービス「codoc」を利用しています。

codocの機能が設置されたページを表示し，またはサポート機能を利用した場合，IPアドレス，ブラウザや端末に関する情報，閲覧ページ，リファラー，Cookieその他の識別子，サービスの利用履歴等がcodoc株式会社に送信される場合があります。

サポート機能を利用する際に入力されたアカウント情報，連絡先情報および取引情報は，codoc株式会社のプライバシーポリシーに従って取り扱われます。決済処理にはStripe Inc.または株式会社CREDIXの決済システムが利用される場合があります。当サイトは，クレジットカード番号その他の決済情報を直接取得または保存しません。

- [codoc利用規約](https://codoc.jp/ja/docs/termsofuse)
- [codocプライバシーポリシー](https://codoc.jp/ja/docs/privacy)
- [Stripeプライバシーポリシー](https://stripe.com/jp/privacy)
- [株式会社CREDIX「個人情報の取り扱い」](https://www.credix-web.co.jp/about_privacy.html)
